...
<?php
            $temp=$_SESSION['id'];
            $search="SELECT id,Name,user,email,Department,Mobile,Address,image_path FROM adminpanel where id= '$temp'";
              ...
              <div class="col-md-8">
                <div class="card mb-3">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-3">
                        <div><h4>Other Details</h4>
                        </div>
                        <div>Lorem ipsum lorepsdasdkhfhaidasihisofhiohaioshiahdifhihsdifhishdfi</div>
                    </div>
                  </div>
                </div>
                </div></div></div></div>
