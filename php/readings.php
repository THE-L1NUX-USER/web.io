...
<div class="container-fluid" style="width: 100%;">
    ...
    <?php
    $query="SELECT * FROM `Inputs` ORDER BY `digital` ASC";
    ...
    while($row=mysqli_fetch_array($rows))
    {
        ...
        echo '<strong>  Board ' . $row["board"] .' - GPIO '.$row["gpio"]. '</strong> - Lastest value:<span style="color:green;"><strong> '. $row['value'] . '</strong></span>';
        echo '<strong> (<a href="delete_input.php?id='.$row['id'].'">Delete</a>)</strong></p><br>';
    };
